...
let project = "EmguCvPlayground"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "EmguCvPlayground"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "EmguCvPlayground"
...
let solutionFile  = "EmguCvPlayground.sln"
...
let gitName = "EmguCvPlayground"

let website = sprintf "/%s" "EmguCvPlayground"
...
let projectsToBuild =
    [|
        ...
        "./src/SolveSudoku/SolveSudoku.fsproj"
        "./src/SudokuFromImage/SudokuFromImage.fsproj"
        "./src/SudokuSolver/SudokuSolver.fsproj"
...
let createAndGetDefault () =
    let clean = BuildTask.create "Clean" [] {
        ...
        Shell.cleanDirs ["bin/Release"; "temp"; projectBin; testBin; benchmarkTestBin]
        }
